...
public class EnemyController : MonoBehaviour
{
    ...
    public  EnemyType currEnemyType;
    private int bossLifeNum = 3;
    ...
    public void KillEnemy()
    {
        ...
        // Boss special case, need shoot three time to die
        if (currEnemyType == EnemyType.Boss && bossLifeNum > 1) {
            bossLifeNum--;
            Vector3 scaleRatio = new Vector3(0.8f, 0.8f, 0.8f);
            transform.localScale = Vector3.Scale(transform.localScale , scaleRatio);
            // Debug.Log("scale dwon " + transform.localScale.ToString("F4"));
        ...
        gameObject.GetComponent<CubeBreaker>().explode();
        //[Example]
        // Destroy(gameObject);
        //[End of Example]
